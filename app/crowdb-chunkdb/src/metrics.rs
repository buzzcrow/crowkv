...
pub struct ChunkdbMetrics {
    ...
    pub allocate_kv_init_persist: Arc<LatencyHistogram>,
    pub allocate_kv_active_persist: Arc<LatencyHistogram>,
...
impl ChunkdbMetrics {
    ...
    pub fn register(registry: &mut MetricsRegistry) -> Self {
        Self {
            ...
            allocate_kv_init_persist: registry.register_histogram("allocate.kv_init_persist.lh"),
            allocate_kv_active_persist: registry.register_histogram("allocate.kv_active_persist.lh"),
